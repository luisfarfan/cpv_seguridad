    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('des_sist', models.CharField(blank=True, db_column='DES_SIST', max_length=18, null=True)),
                ('nom_sist', models.CharField(blank=True, db_column='NOM_SIST', max_length=18, null=True)),
                ('flag_activo', models.CharField(blank=True, db_column='FLAG_ACTIVO', max_length=1, null=True)),
                ('flag_eliminado', models.CharField(blank=True, db_column='FLAG_ELIMINADO', max_length=1, null=True)),
                ('usr_creacion', models.CharField(blank=True, db_column='USR_CREACION', max_length=8, null=True)),
                ('fec_creacion', models.DateTimeField(auto_now_add=True, db_column='FEC_CREACION')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usr_edicion', models.CharField(blank=True, db_column='USR_EDICION', max_length=8, null=True)),
                ('fec_edicion', models.DateTimeField(blank=True, db_column='FEC_EDICION', null=True)),
                ('id_menupermisos', models.ForeignKey(db_column='ID_MENUPERMISOS', on_delete=django.db.models.deletion.CASCADE, to='seguridad.ReMenuPermisos')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ReMenuRol',
            fields=[
                ('id_menurol', models.AutoField(db_column='ID_MENUROL', primary_key=True, serialize=False)),
                ('flag_activo', models.CharField(blank=True, db_column='FLAG_ACTIVO', max_length=1, null=True)),
                ('flag_eliminado', models.CharField(blank=True, db_column='FLAG_ELIMINADO', max_length=1, null=True)),
                ('usr_creacion', models.CharField(blank=True, db_column='USR_CREACION', max_length=8, null=True)),
                ('fec_creacion', models.DateTimeField(auto_now_add=True, db_column='FEC_CREACION')),
                ...
                ('fec_edicion', models.DateTimeField(blank=True, db_column='FEC_EDICION', null=True)),
                ('id_menu', models.ForeignKey(db_column='ID_MENU', on_delete=django.db.models.deletion.CASCADE, to='seguridad.ReMenu')),
                ('id_rol', models.ForeignKey(db_column='ID_ROL', on_delete=django.db.models.deletion.CASCADE, to='seguridad.MaeRol')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='remenupermisosrol',
            name='id_menurol',
            field=models.ForeignKey(db_column='ID_MENUROL', on_delete=django.db.models.deletion.CASCADE, to='seguridad.ReMenuRol'),
        ),
        migrations.AddField(
            model_name='remenu',
        ...
        migrations.AddField(
            model_name='remenu',
            name='padre_id',
            field=models.ForeignKey(db_column='PADRE_ID', on_delete=django.db.models.deletion.CASCADE, to='seguridad.ReMenu'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='remenurol',
            unique_together=set([('id_menu', 'id_rol')]),
        ),
        migrations.AlterUniqueTogether(
            name='remenupermisosrolusuario',
        ...
        migrations.AlterUniqueTogether(
            name='remenupermisosrol',
            unique_together=set([('id_menurol', 'id_menupermisos')]),
        ),
        migrations.AlterUniqueTogether(
            name='remenupermisos',
        ...
        migrations.AlterUniqueTogether(
            name='remenu',
            unique_together=set([('id_proyectosistema',)]),
        ),
    ]
