...
class MaeProyecto(models.Model):
    ...
    tipo_proy = models.CharField(db_column='TIPO_PROY', max_length=1, blank=True, null=True)
    fec_inicio = models.DateTimeField(db_column='FEC_INICIO', blank=True, null=True)
    fec_final = models.DateTimeField(db_column='FEC_FINAL', blank=True, null=True)
...
class MaePermiso(models.Model):
    ...
    des_permiso = models.CharField(db_column='DES_PERMISO', max_length=100, blank=True, null=True)
    cod_permiso = models.CharField(db_column='COD_PERMISO', max_length=4, blank=True, null=True)
    nom_permiso = models.CharField(db_column='NOM_PERMISO', max_length=50, blank=True, null=True)
    flag_activo = models.CharField(db_column='FLAG_ACTIVO', max_length=1, blank=True, null=True)
    flag_eliminado = models.CharField(db_column='FLAG_ELIMINADO', max_length=1, blank=True, null=True)
    usr_creacion = models.CharField(db_column='USR_CREACION', max_length=8, blank=True, null=True)
    fec_creacion = models.DateTimeField(db_column='FEC_CREACION', auto_now_add=True)
...
class MaeRol(models.Model):
    ...
    des_rol = models.CharField(db_column='DES_ROL', max_length=100, blank=True, null=True)
    nom_rol = models.CharField(db_column='NOM_ROL', max_length=50, blank=True, null=True)
    flag_activo = models.CharField(db_column='FLAG_ACTIVO', max_length=1, blank=True, null=True)
    flag_eliminado = models.CharField(db_column='FLAG_ELIMINADO', max_length=1, blank=True, null=True)
    usr_creacion = models.CharField(db_column='USR_CREACION', max_length=8, blank=True, null=True)
    fec_creacion = models.DateTimeField(db_column='FEC_CREACION', auto_now_add=True)
